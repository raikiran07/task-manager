...
const TotalCard = () => {
  ...
  return (
    <div className='border flex bg-white md:bg-transparent items-center justify-between p-4 rounded-lg mt-3 lg:mt-[-30px] shadow-customShadow md:p-0 md:border-none md:shadow-none lg:justify-start md:gap-1 lg:gap-2'>
        <div className="total text-center md:min-w-[120px] lg:min-w-[120px] md:border md:p-6 rounded-md md:shadow-customShadow relative bg-white md:hover:translate-y-[-10px] md:transition-all md:ease-linear cursor-pointer border">
